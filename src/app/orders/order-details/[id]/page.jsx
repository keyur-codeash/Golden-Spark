...
//   useEffect(() => {
//     const getSingleOrderDetails = async () => {
//       const responce = await fetchSingleOrder(id);
//       if (responce?.isSuccess) {
//         setOrderDetails(responce.data[0]);
//       }
//       console.log("responce========", id, responce.data);
//     };
//     getSingleOrderDetails();
//   }, []);
...
//                   return (
//                     <div className="mt-2 border-b pb-4 border-gray-300 flex justify-between items-center">
//                       <div className="">
//                         <p className="text-gray-800 pb-2">
//                           {product?.product_name}
//                         </p>
//                         <p>
//                           Colours: {product?.color} Quantity:
//                           {product?.quantity}
//                         </p>
//                       </div>
//                       <p className="text-gray-800">${product.itemTotal}</p>
//                     </div>
//                   );
//                 })}
...
//                 </li>
//                 <li>
//                   Total: <span> ${orderDetails.grandTotal}</span>
//                 </li>
//                 <li>
//                   Payment method:
//                   <span> {orderDetails.paymentMethod}</span>
