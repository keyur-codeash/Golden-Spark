...
function Page() {
  ...
  useEffect(() => {
    if (cancelId !== null) {
      ...
      console.log("Removed order with ID:", cancelId);
...
//     const response = await fetchOrder(selectedFilter);
...
//   console.log("filteredOrders================================", allOrders);
...
//             <Button
//               label={`Filters${selectedFilter ? `: ${selectedFilter}` : ""}`}
//               icon={<TbFilter className="text-xl" />}
//               color="blue"
//               size="md"
//               variant="solid"
//               className="!bg-brown-900 !rounded-none py-3 lg:mt-5 flex items-center !m-0"
//               onClick={() => setOpenFilter((prev) => !prev)}
//             />
...
//     const responce = await fetchOrder(selectedFilter);
//     console.log("orderssssssssss", responce);

//     if (responce.isSuccess) {
//       setAllorders(responce.data);
//     }
//   };
...
//       <div className="container mx-auto">
//         <div
//           className="flex justify-between items-center pt-8 relative"
//           ref={dropdownRef}
//         >
//           <div>
...
//                     {order.products.map((prod, i) => (
//                       <div key={i}>
//                         <p className="py-1">{prod.product_name}</p>
//                         <p>Price: ${prod.price?.toFixed(2)}</p>
//                         <div className="flex pt-2">
//                           <p>Colour: {prod.color}</p>
//                           <p className="px-4">Quantity: {prod.quantity}</p>
...
//   useEffect(() => {
//     const getAllOrder = async () => {
//       const responce = await fetchOrder();
//       if (responce.isSuccess) {
//         setAllorders(responce.data);
//       }
//     };
...
//                   {/* list all products with same order id */}
//                   <div className="py-2 space-y-1">
//                     {order.products.map((prod, i) => (
//                       <div key={i}>
//                         <p className="py-1">{prod.product_name}</p>
...
//                     <p>
//                       <span>Date: </span>
//                       {formatDate(item?.orderCreated)}
//                     </p>
//                   </div>
//                   <p className="py-2">{item?.product_name}</p>
