...
const Page = () => {
  ...
  useEffect(() => {
    const fetchSingleAddressDetail = async () => {
      try {
        const response = await fetchSingleAddress();
          ...
          <div className="border border-gray-300 w-full rounded-sm p-6 sm:w-1/2 mt-5 sm:mt-10">
            ...
            <div className="text-black ps-9">
              ...
              <div className="pt-4">
                ...
                <div className="pt-5">
                  <button
                    onClick={() => router.push("/orders/order-details")} // Use router.push for client-side navigation
                    type="button"
                    className="text-gray-900 border flex text-lg items-center justify-center border-gray-800 focus:ring-0 cursor-pointer focus:outline-none font-medium rounded-sm px-4 py-2.5 text-center me-2 mb-2"
                  >
