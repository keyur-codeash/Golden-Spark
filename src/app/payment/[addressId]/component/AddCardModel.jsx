...
import { creaditCardValidation } from "@/forntend/validation/validation";

const cardImageMap = {
  visa: "/images/payment_card_one.png",
  "master-card": "/images/payment_card_two.png",
  "american-express": "/images/payment_card_three.png",
  discover: "/images/payment_card_four.png",
};
// const cardImageMap = {
//   visa: "/images/payment_card_one.png",
//   "master-card": "/images/payment_card_two.png",
...
const AddCardModel = ({
  ...
  const formik = useFormik({
    ...
    validationSchema: creaditCardValidation,
    onSubmit: (values) => {
      if (editingCard) {
        onEditCard(values);
      } else {
  ...
  useEffect(() => {
    if (formik.values.cardNumber.length >= 4) {
      const cardInfo = creditCardType(
        formik.values.cardNumber.replace(/\s+/g, "")
      );
      setCardType(cardInfo.length > 0 ? cardInfo[0].type : "visa");
    }
            ...
            <div className="border-1 border-yellow-50 rounded-sm">
              <div className="bg-black text-white px-5 py-4 rounded-t-lg ">
                <div className="md:flex justify-between items-center">
                  ...
                  <div className="flex">
                    {Object.values(cardImageMap).map((item, index) => (
                      <div
                        key={index}
              ...
              <form className="p-5" onSubmit={formik.handleSubmit}>
                <div>
                  <InputField
                    ...
                    className="bg-white"
                    value={formatCardNumberDisplay(formik.values.cardNumber)}
...
//       if (editingCard) {
//         onEditCard({...values, id : editingCard.id});
//       } else {
//         onAddCard(values);
//       }
//     },
