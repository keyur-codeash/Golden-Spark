...
//           "formattedCardNumber================================================",
//           updatedCard,
//         "formattedCardNumber===12",  formattedCardNumber
//         );

//         setCards(
//           cards.map((card) => {
//             console.log(card.id, updatedCard.id ,  card.id === updatedCard.id);
//             card.id === updatedCard.id
//               ? {
//                   ...card,
//                   type: cardType,
//                   cardNumber: updatedCard.cardNumber,
//                   lastFour: updatedCard.cardNumber?.slice(-4),
//                   cardNumber: updatedCard.cardNumber,
//                   cardName: updatedCard.cardName,
//                   cvv: updatedCard.cvv,
//                   cardExpirationDate: updatedCard.expirationDate,
...
// import AddCardModel from "./AddCardModel";
// import creditCardType from "credit-card-type";
// import { createCard, fetchCard } from "@/forntend/services/cardServies";
...
//     const responce = await createCard({
//       cardNumber: newCard.cardNumber,
//       cardName: newCard.cardName,
//       cvv: newCard.cvv,
//       cardExpirationDate: newCard.expirationDate,
...
//     console.log("responce111====", responce);
...
//   useEffect(() => {
//     const fetchCardDetails = async () => {
//       const responce = await fetchCard();
...
//                         <p className="pb-2">{card.cardName}</p>
//                         <p>{`**** **** **** ${
//                           card?.cardNumber ?  Number(card?.cardNumber).slice(-4) : "0000"
//                         }`}</p>
//                       </div>
//                     </div>
//                     <div>
