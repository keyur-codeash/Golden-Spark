...
const ProductDetailsPage = () => {
  ...
  const handleColorSelect = (colorId) => {
    ...
    // Create new selectedVariant with the selected color
    const newSelectedVariant = {
      ...(selectedVariant || {}),
      color: colorId,
      // Keep the current size if it exists, otherwise keep whatever was there
  ...
  const handleSizeSelect = (sizeId) => {
    ...
    // Create new selectedVariant with the selected size
    const newSelectedVariant = {
      ...(selectedVariant || {}),
      size: sizeId,
      // Keep the current color if it exists, otherwise keep whatever was there
