...
const ResponsiveFilter = () => {
  ...
  useEffect(() => {
    ...
    console.log("shopBy====================", shopBy, filters);

    // Delay fetching data to avoid page
...
//       window.scrollTo({ top: 0, behavior: "smooth" }); // Scroll to top when modal is open
//     } else {
//       document.body.style.overflow = "unset"; // Enable scroll when modal is closed
//     }
//     return () => {
//       document.body.style.overflow = "unset"; // Cleanup to ensure scroll is always re-enabled
//     };
//   }, [isModalOpen]);
//   return (
//     <>
